...
// WrapNoErrConsumer adjusts a vvunction that accepts one argument and
// no return to Consumer.
// If f is nil, this function returns nil.
func WrapNoErrConsumer[T any](f func(in T)) Consumer[T] {
	if f == nil {
		return nil
	}
...
// AndThen returns a Consumer composed by arguments. The composed
...
// evaluated.
func AndThen[T any](c1 Consumer[T], c2 ...Consumer[T]) Consumer[T] {
	if c1 == nil {
		return nil
	}
	for _, c := range c2 {
